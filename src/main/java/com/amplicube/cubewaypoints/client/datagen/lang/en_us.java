...
public class en_us extends FabricLanguageProvider {
    ...
    public void generateTranslations(HolderLookup.Provider wrapperLookup, FabricLanguageProvider.TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add("text.autoconfig.cubewaypoints.option.primaryColour", "Primary Waypoint Color");
        translationBuilder.add("text.autoconfig.cubewaypoints.option.secondaryColour", "Secondary Waypoint Color");
